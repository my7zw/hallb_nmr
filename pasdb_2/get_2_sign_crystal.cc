...
int main(int argc, char **argv)
{
  ...
  //TString cf_fn = "mdata/data_86_0/analysis_cnfg_te.txt";
  //TString cf_fn = "mdata/data_86_0/analysis_cnfg_en.txt";
  //TString cf_fn = "mdata/data_60_1/analysis_cnfg_smasig.txt";
  //TString cf_fn = "mdata/data_60_1/analysis_cnfg_bigsig.txt";
  //TString cf_fn = "mdata/data_82_83_cooked/analysis_cnfg_en.txt";
  //TString cf_fn = "mdata/data_82_83_cooked/analysis_cnfg_te.txt";
  //TString cf_fn = "mdata/data_82_83_cooked/analysis_cnfg_en_dBm.txt";  
  //TString cf_fn = "mdata/data_84_scanL/analysis_cnfg_te.txt";
  //TString cf_fn = "mdata/data_84_scanL/analysis_cnfg_en.txt";
  //TString cf_fn = "mdata/data_85_longL/analysis_cnfg_en.txt";
  //TString cf_fn = "mdata/data_85_longL/analysis_cnfg_te.txt";
  //TString cf_fn = "mdata/data_85_night/analysis_cnfg_en.txt";
  //TString cf_fn = "mdata/data_85_night/analysis_cnfg_te.txt";
  //TString cf_fn = "mdata/data_82x/analysis_cnfg_te.txt";
  ...
  //TString cf_fn = "mdata/data_86_87/analysis_cnfg_te_-.txt";//-0+
  //TString cf_fn = "mdata/data_86_87/analysis_cnfg_en_+.txt";//-0+
  TString cf_fn = "mdata/data_86_qcv/analysis_cnfg_te_0.txt";//-0+
  ep->GetConfigInfo(cf_fn.Data());

  ep->GetInitialInfo();
  //ep->InitOutFile("res_cnfg_te_n50/");
  //ep->InitOutFile("res_cnfg_en_n50/");
  //ep->InitOutFile("new_cnfg_teen_n50/");
  ep->InitOutFile("new_cnfg_teen_0/");//-0+
  //ep->InitOutFile("new_cnfg_tail_n50/");
